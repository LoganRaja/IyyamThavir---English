...
public class TIMainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ti_fragment_try);
        ...
        my_query.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TIMainActivity.this, ART_Query_Activity.class);
                intent.putExtra("type","ti");
        ...
        art.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TIMainActivity.this, ActivityWhatAreWe.class);
                intent.putExtra("type","ti");
                startActivity(intent);
            }
        });
        ictc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TIMainActivity.this, FAQActivity.class);
                intent.putExtra("type","ti");
                startActivity(intent);
            }
        });
        ...
        ti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TIMainActivity.this, LocationActivity.class);
                intent.putExtra("type","ti");
                startActivity(intent);
