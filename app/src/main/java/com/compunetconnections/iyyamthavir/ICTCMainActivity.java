 ...
 */
public class ICTCMainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ictc_fragment_try);
        ...
        my_query.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ICTCMainActivity.this, ART_Query_Activity.class);
        ...
        art.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ICTCMainActivity.this, ActivityWhatAreWe.class);
                intent.putExtra("type","ictc");
                startActivity(intent);
            }
        });
        ictc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ICTCMainActivity.this, FAQActivity.class);
                intent.putExtra("type","ictc");
                startActivity(intent);
            }
        });
        bts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("type","ictc");
                startActivity(intent);
                /*new AlertDialog.Builder(ICTCMainActivity.this)
        ...
        ti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ICTCMainActivity.this, LocationActivity.class);
                intent.putExtra("type","ictc");
                intent.putExtra("heading", "ictc");
                startActivity(intent);
